...
fn main() {
    ...
    println!("Problem 12: {:15}, {:?}", result.0, result.1);

    result = problems::problem13::problem13();
    println!("Problem 13: {:15}, {:?}", result.0, result.1);

    result = problems::problem14::problem14();
    println!("Problem 14: {:15}, {:?}", result.0, result.1);

    result = problems::problem15::problem15();
    println!("Problem 15: {:15}, {:?}", result.0, result.1);

    result = problems::problem16::problem16();
    println!("Problem 16: {:15}, {:?}", result.0, result.1);
